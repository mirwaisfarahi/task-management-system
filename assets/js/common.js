...
$(document).on('click', '.delete-report-file-alert', function (e) {
    e.preventDefault();
    var file_id = $(this).data("file_id");
    swal({
        title: 'Are you sure?',
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    url: base_url + 'reporting/delete_report_file/' + file_id,
                    type: "POST",
                    data: csrfName + '=' + csrfHash,
                    success: function (result) {
                        location.reload();
...
$(document).on('click', '.delete-archieve-file-alert', function (e) {
    e.preventDefault();
    var file_id = $(this).data("file_id");
    swal({
        title: 'Are you sure?',
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    url: base_url + 'archieve/delete_archieve_file/' + file_id,
                    type: "POST",
                    data: csrfName + '=' + csrfHash,
                    success: function (result) {
                        location.reload();
...
$(document).on('click', '.delete-report-alert', function (e) {
    e.preventDefault();
    var report_id = $(this).data("report_id");
    swal({
        title: 'Are you sure?',
        text: 'All Report Releted Data Will Once deleted, you will not be able to recover that data!',
        icon: 'warning',
        buttons: true,
        dangerMode: true,
    })
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    url: base_url + 'reporting/delete/' + report_id,
                    type: "POST",
                    data: csrfName + '=' + csrfHash,
                    success: function (result) {
                        location.reload();
...
$(document).on('click', '.delete-archieve-alert', function (e) {
    e.preventDefault();
    var archieve_id = $(this).data("archieve_id");
    swal({
        title: 'Are you sure?',
        text: 'All Archieve Releted Data Will Once deleted, you will not be able to recover that data!',
        icon: 'warning',
        buttons: true,
        dangerMode: true,
    })
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    url: base_url + 'archieve/delete/' + archieve_id,
                    type: "POST",
                    data: csrfName + '=' + csrfHash,
                    success: function (result) {
                        location.reload();
...
$(document).on('click', '.modal-edit-project-ajax', function () {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $('#update_status').trigger('change');
            $('#update_title').val(result.title);
            $('#update_project_number').val(result.project_number);
            $('#update_meeting_lead').val(result.meeting_lead);
            $('#update_project_type').val(result.project_type);
            $('#update_section').val(result.section);
...
$(document).on('click', '.modal-edit-report-ajax', function () {
    var id = $(this).data("id");
    $.ajax({
        type: "POST",
        url: base_url + "reporting/get_report_by_id",
        data: "id=" + id + "&" + csrfName + "=" + csrfHash,
        dataType: "json",
        success: function (result) {
            ...
            $('#update_status').trigger('change');
            $('#update_title').val(result.title);
            $('#update_report_type').val(result.report_type);
            $('#update_description').val(result.description);
            $('#update_id').val(result.id);
            $('#update_end_date').val(result.end_date);
            $('#update_start_date').val(result.start_date);
            $(".modal-edit-report").trigger("click");
        }
    });
});

$(document).on('click', '.modal-edit-archieve-ajax', function () {
    var id = $(this).data("id");
    $.ajax({
        type: "POST",
        url: base_url + "archieve/get_archieve_by_id",
        data: "id=" + id + "&" + csrfName + "=" + csrfHash,
        dataType: "json",
        success: function (result) {
            ...
            $('#update_status').trigger('change');
            $('#update_title').val(result.title);
            $('#update_archieve_type').val(result.archieve_type);
            $('#update_description').val(result.description);
            $('#update_id').val(result.id);
            $('#update_end_date').val(result.end_date);
            $('#update_start_date').val(result.start_date);

            $(".modal-edit-archieve").trigger("click");
        }
    });
});
...
$(document).on('click', '.modal-edit-task-ajax', function () {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $('#update_title').val(result.title);
            $('#update_task_number').val(result.task_number);

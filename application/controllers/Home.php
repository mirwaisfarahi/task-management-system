		...
		if (!$this->ion_auth->logged_in()) {
			...
			if ($total_project != 0) {
				if (is_admin()) {
					...
					$data['finished_project'] = $finished_project/1;
					...
					$data['ongoing_project'] = $ongoing_project/1;
					...
					$data['onhold_project'] = $onhold_project/1;
				}elseif (is_member()) {
					...
					$data['notstarted_project'] = $notstarted_project/1; 

...
class Projects extends CI_Controller
{
	...
	public function create()
	{
    	...
    	$this->form_validation->set_rules('project_type', str_replace(':', '', 'Project Type is empty.'), 'trim|required');
        $this->form_validation->set_rules('section', str_replace(':', '', 'Project section is empty.'), 'trim|required');
		...
		if ($this->form_validation->run() === TRUE) {
			...
			$data = array(
                ...
                'project_number' => $this->input->post('project_number', true),
    			'meeting_lead' => $this->input->post('meeting_lead', true),
				'project_type' => $this->input->post('project_type', true),
                'section' => $this->input->post('section', true),
				'status' => strip_tags($this->input->post('status', true)),
				'class' => $class,
				'budget' => $this->input->post('budget') ? strip_tags($this->input->post('budget', true)) : 0,
	...
	public function edit()
	{
		...
		$this->form_validation->set_rules('title', str_replace(':', '', 'Title is empty.'), 'trim|required');
		$this->form_validation->set_rules('status', str_replace(':', '', 'status is empty.'), 'trim|required');
                $this->form_validation->set_rules('meeting_lead', str_replace(':', '', 'Meeting Lead is empty.'), 'trim|required');
                $this->form_validation->set_rules('project_type', str_replace(':', '', 'Project Type is empty.'), 'trim|required');
                $this->form_validation->set_rules('section', str_replace(':', '', 'Project section is empty.'), 'trim|required');
		$this->form_validation->set_rules('start_date', str_replace(':', '', 'start_date is empty.'), 'trim|required');
		$this->form_validation->set_rules('end_date', str_replace(':', '', 'end_date is empty.'), 'trim|required');
	...
	public function create_milestone()
	{
		...
		$this->form_validation->set_rules('title', str_replace(':', '', 'Title is empty.'), 'trim|required');
        $this->form_validation->set_rules('meeting_date', str_replace(':', '', 'Meeting date is empty.'), 'trim|required');
		$this->form_validation->set_rules('status', str_replace(':', '', 'status is empty.'), 'trim|required');
		...
		if ($this->form_validation->run() === TRUE) {
			...
			$data = array(
				'title' => strip_tags($this->input->post('title', true)),
                'meeting_head' => strip_tags($this->input->post('meeting_head', true)),
	...
	public function create_task()
	{
        ...
        $this->form_validation->set_rules('start_date', str_replace(':', '', 'Start date is empty.'), 'trim|required');
		$this->form_validation->set_rules('description', str_replace(':', '', 'description is empty.'), 'trim|required');

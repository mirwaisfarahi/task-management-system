        ...
        <ul class="sidebar-menu">
            ...
            <?php if (!empty($this->session->has_userdata('workspace_id'))) { ?>
                ...
                <?php if (!is_client()) { ?>
                    ...
                    <li <?= (current_url() == base_url('reporting')) ? 'class="active"' : ''; ?>><a class="nav-link" href="<?= base_url('reporting'); ?>"><i class="fas fa-file text-primary"></i> <span>
                                <?= !empty($this->lang->line('label_report')) ? $this->lang->line('label_report') : 'Report'; ?>
                            </span></a>
                    </li>

                    <li <?= (current_url() == base_url('archieve')) ? 'class="active"' : ''; ?>><a class="nav-link" href="<?= base_url('archieve'); ?>"><i class="fas fa-file-archive text-success"></i> <span>
                                <?= !empty($this->lang->line('label_archieve')) ? $this->lang->line('label_archieve') : 'Archive'; ?>
                            </span></a>
                    </li>

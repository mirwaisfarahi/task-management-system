        ...
        <div class="main-wrapper main-wrapper-1">
                                            ...
                                            ?>
                                                    ...
                                                    <div class="card mb-0" id="<?= $task['id'] ?>">
                                                        <div class="card-body p-3">
                                                            ...
                                                            <span class="badge badge-<?= $task['class'] ?> projects-badge"><?= !empty($this->lang->line('label_low')) ? $this->lang->line('label_low') : 'Low'; ?></span>
                                                            <?php } ?>
                                                            <?php
                                                            if($task['priority'] == 'medium') { ?>
                                                            <span class="badge badge-<?= $task['class'] ?> projects-badge"><?= !empty($this->lang->line('label_medium')) ? $this->lang->line('label_medium') : 'Medium'; ?></span>
                                                            <?php } ?>
                                                            <?php
                                                            if($task['priority'] == 'high') { ?>
                                                            <span class="badge badge-<?= $task['class'] ?> projects-badge"><?= !empty($this->lang->line('label_high')) ? $this->lang->line('label_high') : 'High'; ?></span>
                                                            <?php } ?>
                                                            <p class="mt-2 mb-2">
            ...
            <form action="<?= base_url('projects/create_task/' . $current_project['id']); ?>" method="post" class="modal-part" id="modal-add-task-part">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label><?= !empty($this->lang->line('label_task_number')) ? $this->lang->line('label_task_number') : 'Task ID'; ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Task ID" name="task_number">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label><?= !empty($this->lang->line('label_task_number')) ? $this->lang->line('label_task_number') : 'Task ID'; ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Task" name="task_number" id="update_task_number">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">

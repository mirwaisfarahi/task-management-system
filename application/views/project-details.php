        ...
        <div class="main-wrapper main-wrapper-1">
                                ...
                                <div class="card author-box card-<?= $projects['class']; ?>">
                                    <div class="card-body">
                                        <div class="author-box-name">
                                            <h5><?= $projects['title']; ?> : <?= $projects['project_number']; ?> </h5>
                                        </div>
                                        <div class="author-box-job">
                                            ...
                                            <div class="float-right mt-sm-1">
                                                ...
                                                <br/><b><?= !empty($this->lang->line('label_meeting_lead')) ? $this->lang->line('label_meeting_lead') : 'Ordered By'; ?>: </b><?= $projects['meeting_lead']; ?> <b><?= !empty($this->lang->line('label_project_type')) ? $this->lang->line('label_project_type') : 'Project Type'; ?>: </b><?= $projects['project_type']; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-responsive table-invoice">
                                            <table class="table table-striped">
                                                <tr>
                                                    ...
                                                    <th><?= !empty($this->lang->line('label_meeting_head')) ? $this->lang->line('label_meeting_head') : 'Meeting Head'; ?></th>
                                                    <th><?= !empty($this->lang->line('label_start_date')) ? $this->lang->line('label_start_date') : 'Date'; ?></th>
                                                ...
                                                foreach ($milestones as $milestone) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $milestone['meeting_head'] ?></td>
                                                        <td><?= $milestone['meeting_date'] ?></td>
                                                        <td>
            ...
            <form action="<?= base_url('projects/create_milestone/' . $projects['id']); ?>" method="post" class="modal-part" id="modal-add-milestone-part">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label><?= !empty($this->lang->line('label_meeting_head')) ? $this->lang->line('label_meeting_head') : 'Meeting Head'; ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Meeting Lead" name="meeting_head">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="meeting_date"><?= !empty($this->lang->line('label_start_date')) ? $this->lang->line('label_start_date') : 'Start Date'; ?></label>
                            <input class="form-control datepicker" type="text" id="meeting_date" name="meeting_date" value="2021-02-03" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="hidden" name="update_id" id="update_id">
                                <input type="text" class="form-control" placeholder="Meeting Lead" id="update_meeting_head" name="meeting_head">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="meeting_date"><?= !empty($this->lang->line('label_start_date')) ? $this->lang->line('label_start_date') : 'Start Date'; ?></label>
                            <input class="form-control datepicker" type="text" id="update_meeting_date" name="meeting_date" value="2021-02-03" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row">
